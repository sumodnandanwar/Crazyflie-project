...
class OccupancyGridMap:
    ...
    @staticmethod
    def from_png(filename = '/home/sumslinux/dd2419_ws/src/localization2/maps/2D map.png', cell_size = 1):
        """
...
def read_json(path = '/home/sumslinux/dd2419_ws/src/course_packages/dd2419_resources/worlds_json/milestone3.world.json'):
    ...
    img[:,:,2] = grid * 255
    #cv2.imshow("2D map", img)
    cv2.imwrite('/home/sumslinux/dd2419_ws/src/localization/maps/2D map.png',img) 

    ogm_from_json = OccupancyGridMap.from_png('/home/sumslinux/dd2419_ws/src/localization/maps/2D map.png', 0.1)
